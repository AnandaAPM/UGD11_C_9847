package com.pbp.gd11_c_9847.ui.home;
...
public class HomeFragment extends Fragment {
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyHolder> {
        ...
        public int getItemViewType(int position) {
            if (position==1 || position==3 || position==5 || position==8 ) {
                return 1;
            }
            return 0;
        }
        ...
        public void onBindViewHolder(MyHolder holder, int position) {
            if (position==1 || position==5 ) {
                ...
                holder.windowImageView.bindRecyclerView(rv);
                holder.windowImageView.setFrescoEnable(false);
                holder.windowImageView.setImageResource(R.drawable.xxx);
            }else if(position==3){

                holder.windowImageView.bindRecyclerView(rv);
                holder.windowImageView.setFrescoEnable(true);
                holder.windowImageView.setImageURI(Uri.parse("https://www.mordeo.org/files/uploads/2020/11/Horizon-Apex-Legends-4K-Ultra-HD-Mobile-Wallpaper-950x1689.jpg"));
            }
            else {
